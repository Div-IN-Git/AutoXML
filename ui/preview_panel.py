...
COLORS = {"surname": "#4ED17B", "given-names": "#4C8DFF", "collab": "#FF971D", "suffix": "#F4CF39", "unknown": "#F4B400"}
...
class PreviewPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        bottom = QSplitter(Qt.Orientation.Horizontal); bottom.setMinimumHeight(245); bottom.addWidget(self._preview_card("XML PREVIEW (Original)", "original")); bottom.addWidget(self._preview_card("XML PREVIEW (Preview with your changes)", "changed"))
    ...
    def set_document(self, document):
        ...
        for row, item in enumerate(document.items):
            ...
            holder = QWidget(); holder.setObjectName("tagCell"); cell_layout = QHBoxLayout(holder); cell_layout.setContentsMargins(6, 4, 6, 4); cell_layout.addWidget(combo)
